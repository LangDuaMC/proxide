...
class ConnectedPlayerSessionTimeHook(plugin: ProxidePlugin) :
    ConnectedPlayerListHookBase<Long>(plugin), Listener {
    ...
    override fun collect(player: ProxiedPlayer) =
        sessionStartTimes[player.uniqueId]?.let { startTime ->
